...
Vector2D Planet::getPosition() const {
    return position;
}
...
bool Planet::isHabitable() const {
    // Example logic: return true if habitabilityIndex is above a certain threshold
...
bool Planet::isInHabitableZone() const {
    ...
    return m_distanceFrom >=  100.0 && m_distanceFrom <=  200.0; // Replace with your actual logic
}
